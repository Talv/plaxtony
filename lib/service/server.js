...
class Server {
    ...
    onDidClose(ev) {
        ...
        if (!this.store.rootPath || !lib_1.default.parse(ev.document.uri).fsPath.startsWith(this.store.rootPath)) {
    ...
    onDidSave(ev) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.flushDocument(ev.document.uri);
        });
    }
