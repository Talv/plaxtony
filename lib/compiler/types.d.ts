...
export declare const enum SyntaxKind {
    ...
    DoodadKeyword = 84,
    HandleKeyword = 85,
    GenerichandleKeyword = 86,
    EffecthistoryKeyword = 87,
    MarkerKeyword = 88,
    OrderKeyword = 89,
    PlayergroupKeyword = 90,
    PointKeyword = 91,
    RegionKeyword = 92,
    RevealerKeyword = 93,
    SoundKeyword = 94,
    ...
    TextKeyword = 96,
    TimerKeyword = 97,
    TransmissionsourceKeyword = 98,
    TriggerKeyword = 99,
    UnitKeyword = 100,
    UnitfilterKeyword = 101,
    UnitgroupKeyword = 102,
    UnitrefKeyword = 103,
    VoidKeyword = 104,
    WaveKeyword = 105,
    WaveinfoKeyword = 106,
    WavetargetKeyword = 107,
    ArrayrefKeyword = 108,
    StructrefKeyword = 109,
    FuncrefKeyword = 110,
    Identifier = 111,
    EndOfFileToken = 112,
    TypeReference = 113,
    MappedType = 114,
    ArrayType = 115,
    ArrayLiteralExpression = 116,
    ElementAccessExpression = 117,
    PropertyAccessExpression = 118,
    CallExpression = 119,
    PrefixUnaryExpression = 120,
    PostfixUnaryExpression = 121,
    BinaryExpression = 122,
    TypeAssertionExpression = 123,
    ParenthesizedExpression = 124,
    SourceFile = 125,
    Block = 126,
    IfStatement = 127,
    DoStatement = 128,
    ...
    VariableDeclaration = 138,
    FunctionDeclaration = 139,
    ParameterDeclaration = 140,
    PropertyDeclaration = 141,
    TypedefDeclaration = 142,
}
