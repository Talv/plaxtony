...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["AnimfilterKeyword"] = 76] = "AnimfilterKeyword";
    SyntaxKind[SyntaxKind["BankKeyword"] = 77] = "BankKeyword";
    SyntaxKind[SyntaxKind["BitmaskKeyword"] = 78] = "BitmaskKeyword";
    SyntaxKind[SyntaxKind["CamerainfoKeyword"] = 79] = "CamerainfoKeyword";
    SyntaxKind[SyntaxKind["ColorKeyword"] = 80] = "ColorKeyword";
    SyntaxKind[SyntaxKind["DoodadKeyword"] = 81] = "DoodadKeyword";
    SyntaxKind[SyntaxKind["HandleKeyword"] = 82] = "HandleKeyword";
    SyntaxKind[SyntaxKind["GenerichandleKeyword"] = 83] = "GenerichandleKeyword";
    SyntaxKind[SyntaxKind["EffecthistoryKeyword"] = 84] = "EffecthistoryKeyword";
    SyntaxKind[SyntaxKind["MarkerKeyword"] = 85] = "MarkerKeyword";
    SyntaxKind[SyntaxKind["OrderKeyword"] = 86] = "OrderKeyword";
    SyntaxKind[SyntaxKind["PlayergroupKeyword"] = 87] = "PlayergroupKeyword";
    SyntaxKind[SyntaxKind["PointKeyword"] = 88] = "PointKeyword";
    SyntaxKind[SyntaxKind["RegionKeyword"] = 89] = "RegionKeyword";
    SyntaxKind[SyntaxKind["RevealerKeyword"] = 90] = "RevealerKeyword";
    SyntaxKind[SyntaxKind["SoundKeyword"] = 91] = "SoundKeyword";
    SyntaxKind[SyntaxKind["SoundlinkKeyword"] = 92] = "SoundlinkKeyword";
    SyntaxKind[SyntaxKind["TextKeyword"] = 93] = "TextKeyword";
    SyntaxKind[SyntaxKind["TimerKeyword"] = 94] = "TimerKeyword";
    SyntaxKind[SyntaxKind["TransmissionsourceKeyword"] = 95] = "TransmissionsourceKeyword";
    SyntaxKind[SyntaxKind["TriggerKeyword"] = 96] = "TriggerKeyword";
    SyntaxKind[SyntaxKind["UnitKeyword"] = 97] = "UnitKeyword";
    SyntaxKind[SyntaxKind["UnitfilterKeyword"] = 98] = "UnitfilterKeyword";
    SyntaxKind[SyntaxKind["UnitgroupKeyword"] = 99] = "UnitgroupKeyword";
    SyntaxKind[SyntaxKind["UnitrefKeyword"] = 100] = "UnitrefKeyword";
    SyntaxKind[SyntaxKind["VoidKeyword"] = 101] = "VoidKeyword";
    SyntaxKind[SyntaxKind["WaveKeyword"] = 102] = "WaveKeyword";
    SyntaxKind[SyntaxKind["WaveinfoKeyword"] = 103] = "WaveinfoKeyword";
    SyntaxKind[SyntaxKind["WavetargetKeyword"] = 104] = "WavetargetKeyword";
    // Ref types
    SyntaxKind[SyntaxKind["ArrayrefKeyword"] = 105] = "ArrayrefKeyword";
    SyntaxKind[SyntaxKind["StructrefKeyword"] = 106] = "StructrefKeyword";
    SyntaxKind[SyntaxKind["FuncrefKeyword"] = 107] = "FuncrefKeyword";
    //
    SyntaxKind[SyntaxKind["Identifier"] = 108] = "Identifier";
    SyntaxKind[SyntaxKind["EndOfFileToken"] = 109] = "EndOfFileToken";
    // Elements
    SyntaxKind[SyntaxKind["TypeReference"] = 110] = "TypeReference";
    SyntaxKind[SyntaxKind["MappedType"] = 111] = "MappedType";
    SyntaxKind[SyntaxKind["ArrayType"] = 112] = "ArrayType";
    SyntaxKind[SyntaxKind["ArrayLiteralExpression"] = 113] = "ArrayLiteralExpression";
    SyntaxKind[SyntaxKind["ElementAccessExpression"] = 114] = "ElementAccessExpression";
    SyntaxKind[SyntaxKind["PropertyAccessExpression"] = 115] = "PropertyAccessExpression";
    SyntaxKind[SyntaxKind["CallExpression"] = 116] = "CallExpression";
    SyntaxKind[SyntaxKind["PrefixUnaryExpression"] = 117] = "PrefixUnaryExpression";
    SyntaxKind[SyntaxKind["PostfixUnaryExpression"] = 118] = "PostfixUnaryExpression";
    SyntaxKind[SyntaxKind["BinaryExpression"] = 119] = "BinaryExpression";
    SyntaxKind[SyntaxKind["TypeAssertionExpression"] = 120] = "TypeAssertionExpression";
    SyntaxKind[SyntaxKind["ParenthesizedExpression"] = 121] = "ParenthesizedExpression";
    SyntaxKind[SyntaxKind["SourceFile"] = 122] = "SourceFile";
    SyntaxKind[SyntaxKind["Block"] = 123] = "Block";
    SyntaxKind[SyntaxKind["IfStatement"] = 124] = "IfStatement";
    SyntaxKind[SyntaxKind["DoStatement"] = 125] = "DoStatement";
    SyntaxKind[SyntaxKind["WhileStatement"] = 126] = "WhileStatement";
    SyntaxKind[SyntaxKind["ForStatement"] = 127] = "ForStatement";
    SyntaxKind[SyntaxKind["BreakStatement"] = 128] = "BreakStatement";
    SyntaxKind[SyntaxKind["ContinueStatement"] = 129] = "ContinueStatement";
    SyntaxKind[SyntaxKind["IncludeStatement"] = 130] = "IncludeStatement";
    SyntaxKind[SyntaxKind["ReturnStatement"] = 131] = "ReturnStatement";
    SyntaxKind[SyntaxKind["ExpressionStatement"] = 132] = "ExpressionStatement";
    SyntaxKind[SyntaxKind["EmptyStatement"] = 133] = "EmptyStatement";
    SyntaxKind[SyntaxKind["StructDeclaration"] = 134] = "StructDeclaration";
    SyntaxKind[SyntaxKind["VariableDeclaration"] = 135] = "VariableDeclaration";
    SyntaxKind[SyntaxKind["FunctionDeclaration"] = 136] = "FunctionDeclaration";
    SyntaxKind[SyntaxKind["ParameterDeclaration"] = 137] = "ParameterDeclaration";
    SyntaxKind[SyntaxKind["PropertyDeclaration"] = 138] = "PropertyDeclaration";
    SyntaxKind[SyntaxKind["TypedefDeclaration"] = 139] = "TypedefDeclaration";
})(SyntaxKind = exports.SyntaxKind || (exports.SyntaxKind = {}));
var SyntaxKindMarker;
(function (SyntaxKindMarker) {
    SyntaxKindMarker[SyntaxKindMarker["FirstToken"] = 1] = "FirstToken";
    SyntaxKindMarker[SyntaxKindMarker["LastToken"] = 108] = "LastToken";
    SyntaxKindMarker[SyntaxKindMarker["FirstKeyword"] = 49] = "FirstKeyword";
    SyntaxKindMarker[SyntaxKindMarker["LastKeyword"] = 107] = "LastKeyword";
    ...
    SyntaxKindMarker[SyntaxKindMarker["LastComplexType"] = 104] = "LastComplexType";
    SyntaxKindMarker[SyntaxKindMarker["FirstTypeNode"] = 110] = "FirstTypeNode";
    SyntaxKindMarker[SyntaxKindMarker["LastTypeNode"] = 112] = "LastTypeNode";
...
(function (TypeFlags) {
    ...
    TypeFlags[TypeFlags["Fixed"] = 8] = "Fixed";
    ...
    TypeFlags[TypeFlags["Null"] = 2048] = "Null";
    TypeFlags[TypeFlags["Struct"] = 4096] = "Struct";
    TypeFlags[TypeFlags["Function"] = 8192] = "Function";
    TypeFlags[TypeFlags["Complex"] = 16384] = "Complex";
    TypeFlags[TypeFlags["Array"] = 32768] = "Array";
    TypeFlags[TypeFlags["Mapped"] = 65536] = "Mapped";
    TypeFlags[TypeFlags["Funcref"] = 131072] = "Funcref";
    TypeFlags[TypeFlags["Arrayref"] = 262144] = "Arrayref";
    TypeFlags[TypeFlags["Structref"] = 524288] = "Structref";
    TypeFlags[TypeFlags["Typedef"] = 1048576] = "Typedef";
    /* @internal */
    TypeFlags[TypeFlags["Nullable"] = 2048] = "Nullable";
    TypeFlags[TypeFlags["Literal"] = 448] = "Literal";
    TypeFlags[TypeFlags["Numeric"] = 12] = "Numeric";
    TypeFlags[TypeFlags["Reference"] = 917504] = "Reference";
